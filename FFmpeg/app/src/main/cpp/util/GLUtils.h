...
#ifndef FFMPEGDEMO_GLUTILS_H
#define FFMPEGDEMO_GLUTILS_H
#include <GLES3/gl3.h>
#include <string>
#include <glm.hpp>
...
public:
    ...
    static  GLuint  createProgram(const char *pVertexShader,const char *pFragShaderSource);
    static GLuint  createProgramWithFeedback(const char *pVertexShaderSource,const char *pFragShaderSource,GLuint &vertexShaderHandle,GLuint &fragShaderHandle,const GLchar **varying,int varyingCount);
    ...
    static glm::vec3 texCoordToVertexCoord(glm::vec2 texCoord){
        return  glm::vec3 (2*texCoord.x,1-2*texCoord.y,0);
    }
